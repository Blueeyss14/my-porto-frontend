    ...
    <div>
      ...
      <div className="flex overflow-x-auto flex-nowrap mb-10">
        {pinnedProjects.map((project, index) => (
          <div
            key={project.id}
            className="w-1/3 shrink-0 [@media(max-width:1400px)]:w-1/2 [@media(max-width:870px)]:w-full h-150 p-4 overflow-hidden"
          >
            <div className="h-full flex flex-col items-center rounded-2xl overflow-hidden shadow-white/5 shadow-[05px_5px_15px_black] backdrop-blur-[60px] bg-homeBg/10 border-2 border-white/10 p-5">
