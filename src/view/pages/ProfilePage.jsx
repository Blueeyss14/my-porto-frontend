...
const ProfilePage = () => {
  return (
    ...
    >
      <div className="w-[90%] h-full flex items-center  [@media(max-width:850px)]:items-start [@media(max-width:500px)]:w-[80%]">
        <div className="w-[50%] pr-5 flex flex-col [@media(max-width:850px)]:items-start [@media(max-width:850px)]:w-full [@media(max-width:850px)]:mt-10">
          <TypewriterLoop
            text="I'm Delkano"
            speed={100}
          ...
          <h1 className="leading-8 [@media(max-width:1000px)]:leading-7 text-homeBg2/80 text-[1.2rem] [@media(max-width:1000px)]:text-[0.9rem] [@media(max-width:850px)]:text-justify [@media(max-width:500px)]:text-[0.7rem] [@media(max-width:500px)]:leading-5">
