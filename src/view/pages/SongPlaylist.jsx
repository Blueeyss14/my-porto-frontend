...
export default function SongPlaylist() {
  ...
  return (
    <div className="flex w-[90%] items-start">
      {/* MUSIC PLAYER */}
      <div className="[@media(max-height:751px)]:h-120 [@media(min-height:750px)]:h-140 min-w-95 max-w-100 mr-10 overflow-hidden [@media(max-width:900px)]:w-full [@media(max-width:900px)]:max-w-full [@media(max-width:900px)]:mr-0 [@media(max-width:900px)]:min-w-full">
        <BlurBackgorund
